...
.llm-date-range-picker {
  ...
  .CalendarDay__selected_start {
    border-left: 2px solid rgba(241, 102, 34, 1);
  }
  ...
  .CalendarDay__selected_end {
    border-right: 2px solid rgba(241, 102, 34, 1);
  }
  ...
  .DayPicker {
    ...
    position: relative;
    text-align: left;
    box-shadow: 0px 2px 8px 0px rgba(83, 83, 83, 0.2);
    border-radius: 2px;
  ...
  .DateRangePickerInput_calendarIcon:focus {
    outline: rgba(178, 178, 178, 1) auto 2px;
  }
